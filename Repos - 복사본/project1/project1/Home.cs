...
namespace project1
{
    public partial class Home : Form
    {
        ...
        public object lb1 { get; internal set; }
        ...
        private void btnOrder_Click(object sender, EventArgs e)
        {
            ...
            //if (store != "") store = cbStore.SelectedItem.ToString();
            //    else
            //    {
            //        label3.Text = "지점을 선택하세요";
            //        return;
            //    }
            time = cbTime.SelectedItem.ToString();
            //if (time != "") time = cbTime.SelectedItem.ToString();
            //else
            //{
            //    label3.Text = "시간을 선택하세요";
            //    return;
            //}
            if (rbOne.Checked)
            {
